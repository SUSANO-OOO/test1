window.MEALLENS_FOOD_DATA = {
  "source": {
    "name": "日本食品標準成分表（八訂）増補2023年",
    "publisher": "文部科学省",
    "basis": "可食部100g当たり",
    "fields": "エネルギー、たんぱく質、脂質、利用可能炭水化物"
  },
  "foods": [
    {
      "id": "01001",
    ...
    {
      "id": "17042",
      "name": "＜調味料類＞ （ドレッシング類） 半固体状ドレッシング マヨネーズ 全卵型",
      "kcal": 668,
      "p": 1.4,
      "f": 76,
      "c": 2.1
    ...
    {
      "id": "17043",
      "name": "＜調味料類＞ （ドレッシング類） 半固体状ドレッシング マヨネーズ 卵黄型",
      "kcal": 668,
      "p": 2.5,
      "f": 74.7,
      "c": 0.5
    ...
    {
      "id": "17118",
      "name": "＜調味料類＞ （ドレッシング類） 半固体状ドレッシング マヨネーズタイプ調味料 低カロリータイプ",
      "kcal": 262,
      "p": 2.9,
      "f": 28.3,
      "c": 2.6
